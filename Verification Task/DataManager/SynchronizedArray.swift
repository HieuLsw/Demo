...
public class SynchronizedArray<Element> {
    fileprivate let queue = DispatchQueue(label: "io.Hieutt.SoftwareKit.SynchronizedArray", attributes: .concurrent)
...
public extension SynchronizedArray {
    ...
    func removeSubRange(_ range: CountableClosedRange<Int>) -> Void {
        queue.sync{ 
            self.array.removeSubrange(range)
        }
    } 
}
